...
mixin _$SignInState {
 ...
 String? get emailError; String? get passwordError; bool get isPasswordVisible; bool get isLoading;
...
@override
int get hashCode => Object.hash(runtimeType,emailError,passwordError,isPasswordVisible,isLoading);

@override
String toString() {
  return 'SignInState(emailError: $emailError, passwordError: $passwordError, isPasswordVisible: $isPasswordVisible, isLoading: $isLoading)';
}
...
@useResult
$Res call({
 String? emailError, String? passwordError, bool isPasswordVisible, bool isLoading
});
...
/// Create a copy of SignInState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? emailError = freezed,Object? passwordError = freezed,Object? isPasswordVisible = null,Object? isLoading = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? emailError,  String? passwordError,  bool isPasswordVisible,  bool isLoading)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignInState() when $default != null:
return $default(_that.emailError,_that.passwordError,_that.isPasswordVisible,_that.isLoading);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? emailError,  String? passwordError,  bool isPasswordVisible,  bool isLoading)  $default,) {final _that = this;
switch (_that) {
case _SignInState():
return $default(_that.emailError,_that.passwordError,_that.isPasswordVisible,_that.isLoading);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? emailError,  String? passwordError,  bool isPasswordVisible,  bool isLoading)?  $default,) {final _that = this;
switch (_that) {
case _SignInState() when $default != null:
return $default(_that.emailError,_that.passwordError,_that.isPasswordVisible,_that.isLoading);case _:
  return null;
...
class _SignInState extends SignInState {
  const _SignInState({this.emailError, this.passwordError, this.isPasswordVisible = false, this.isLoading = false}): super._();
...
/// Create a copy of SignInState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? emailError = freezed,Object? passwordError = freezed,Object? isPasswordVisible = null,Object? isLoading = null,}) {
